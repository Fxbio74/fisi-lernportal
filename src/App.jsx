    ...
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.93)",zIndex:100,display:"flex",alignItems:"center",justifyContent:"center",padding:"1rem"}}>
      <div style={{background:"#080808",border:`1px solid ${col.badge}30`,borderRadius:"16px",width:"100%",maxWidth:"820px",maxHeight:"93vh",overflow:"auto",position:"relative"}}>
        <div style={{padding:"1.25rem 1.75rem",borderBottom:`1px solid ${col.badge}18`,background:`linear-gradient(135deg,${col.bg}bb,#080808)`,position:"sticky",top:0,zIndex:10}}>
          {/* X Button absolut oben rechts - immer erreichbar */}
          <button onClick={onClose} style={{position:"absolute",top:"1rem",right:"1rem",width:"36px",height:"36px",background:"#1e1e1e",border:"1px solid #2a2a2a",borderRadius:"8px",cursor:"pointer",color:"#aaa",display:"flex",alignItems:"center",justifyContent:"center",zIndex:20,flexShrink:0}} onMouseEnter={e=>e.currentTarget.style.background="#2a2a2a"} onMouseLeave={e=>e.currentTarget.style.background="#1e1e1e"}><Icon name="close" size={16}/></button>

          <div style={{display:"flex",flexDirection:"column",gap:"0.75rem",paddingRight:"2.5rem"}}>
            {/* Titel + Meta */}
            <div>
              <div style={{display:"flex",gap:"0.5rem",marginBottom:"0.4rem",flexWrap:"wrap"}}>
                ...
                {fortschritt[item.id]?.verstanden&&<span style={{fontSize:"0.58rem",color:"#22c55e",background:"#22c55e12",padding:"0.18rem 0.5rem",borderRadius:"4px",border:"1px solid #22c55e25",fontWeight:"bold"}}>✓ Verstanden</span>}
              </div>
              <div style={{fontSize:"1.15rem",fontWeight:"bold",color:"#eee",fontFamily:"'Courier New',monospace",lineHeight:1.3}}>{item.title}</div>
            ...
            <div style={{display:"flex",gap:"0.4rem",flexWrap:"wrap"}}>
              ...
              {item.type==="text"&&<button onClick={handleSpeak} style={{background:speaking?"#1a0a2e":"none",border:`1px solid ${speaking?"#a855f7":"#2a2a2a"}`,borderRadius:"7px",padding:"0.4rem 0.65rem",cursor:"pointer",color:speaking?"#a855f7":"#666",fontSize:"0.75rem",fontFamily:"inherit"}}>{speaking?"⏹":"🔊"}</button>}
